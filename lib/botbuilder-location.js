...
exports.createLibrary = function (connection, apiKey, country = null) {
  if (typeof connection === "undefined" || typeof apiKey === "undefined") {
  ...
  retrieveLocationDialog.register(lib, connection, apiKey, country);
