...
function createDialog() {
    return [
        function (session, args) {
            ...
            session.send(botbuilder_1.Prompts.choice(session, session.gettext(consts_1.Strings.SingleResultFound), [session.gettext(consts_1.Strings.ConfirmationTrue), session.gettext(consts_1.Strings.ConfirmationFalse)], {
